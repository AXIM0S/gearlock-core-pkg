...
# If you want to use boot-scripts then go check `gearlock/gerboot` dir
# If you want to push an extension script which can run inside `GearLock > Extensions` then check `gearlock/extension.sh`
